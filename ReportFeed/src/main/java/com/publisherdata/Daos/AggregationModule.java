...
public List<PublisherReport> SessionDurationChannel(String startdate, String enddate, String channel_name)
    ...
    throws SQLFeatureNotSupportedException, SqlParseException, CsvExtractorException, Exception
  {
	String query = "";        
			...
			if(filter != null && !filter.isEmpty()  && filter.equals("visitorCount") )
			query = "Select "+queryfield+",cookie_id FROM enhanceduserdatabeta1 where channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "' GROUP by "+ queryfield+",cookie_id";  
  ...
  public List<PublisherReport> getQueryFieldChannelLive(String queryfield,String startdate, String enddate, String channel_name, String filter)
      ...
      if(filter != null && !filter.isEmpty()  && filter.equals("visitorCount") )
      query = "Select "+queryfield+",cookie_id FROM enhanceduserdatabeta1 where channel_name = '" + channel_name + "' and request_time between " + "'" + startdate + "'" + " and " + "'" + enddate + "' GROUP by "+ queryfield+",cookie_id";  
  ...
  */
  ...
  public List<PublisherReport> getQueryFieldChannelFilter(String queryfield,String startdate, String enddate, String channel_name, Map<String,String>filter, String filtermetric)
		    throws SQLFeatureNotSupportedException, SqlParseException, CsvExtractorException, Exception
		  {
		    ...
		    query = "Select "+queryfield+",cookie_id"+" from enhanceduserdatabeta1 where "+queryfilterbuilder+" and channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "'"+" GROUP BY "+queryfield+",cookie_id";  
...
*/
  ...
  public List<PublisherReport> getQueryFieldChannelGroupBy(String queryfield,String startdate, String enddate, String channel_name, List<String> groupby, String filter)
      ...
      if(filter == null || filter.isEmpty() ||  filter.equals("pageviews"))
    	    ...
    	    if(filter != null && !filter.isEmpty()  && filter.equals("visitorCount"))
    	     	query = "Select "+queryfield+","+querygroupbybuilder+",cookie_id FROM enhanceduserdatabeta1 where channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "' GROUP by "+ queryfield+","+querygroupbybuilder+",cookie_id";  
    	  ...
    	  //  	query = "Select SUM(engagementTime),"+queryfield+" from enhanceduserdatabeta1 where channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "'" + " GROUP BY "+queryfield+","+"date_histogram(field='request_time','interval'='1s')";
    	    ...
    	    if(querygroupbybuilder.equals("hour")){
    	    	if(filter != null && !filter.isEmpty() &&  filter.equals("visitorCount"))
    	    	query = "Select "+queryfield+",cookie_id from enhanceduserdatabeta1 where channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "'" + " GROUP BY "+queryfield+","+"date_histogram(field='request_time','interval'='1h'),cookie_id";
    	    ...
    	    if(querygroupbybuilder.equals("minute")){
    	   	if(filter != null && !filter.isEmpty() &&  filter.equals("visitorCount"))
    	   	query = "Select "+queryfield+",cookie_id from enhanceduserdatabeta1 where channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "'" + " GROUP BY "+queryfield+","+"date_histogram(field='request_time','interval'='1m'),cookie_id";
    	    	   
    	    } 	
    	    
    	    if(querygroupbybuilder.equals("second")){
    	    //	if(filter != null && !filter.isEmpty() &&  filter.equals("visitorCount"))
    	    //	query = "Select "+queryfield+",cookie_id from enhanceduserdatabeta1 where channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "'" + " GROUP BY "+queryfield+","+"date_histogram(field='request_time','interval'='1s'),cookie_id";
...
public List<PublisherReport> getQueryFieldChannelGroupByLive(String queryfield,String startdate, String enddate, String channel_name, List<String> groupby, String filter)
    ...
    if(filter != null && !filter.isEmpty()  && filter.equals("visitorCount"))
     	query = "Select "+queryfield+","+querygroupbybuilder+",cookie_id from enhanceduserdatabeta1 where channel_name = '" + channel_name + "' and request_time between " + "'" + startdate + "'" + " and " + "'" + enddate + "'" + " GROUP BY "+queryfield+","+querygroupbybuilder+","+"cookie_id";
  ...
  public List<PublisherReport> getQueryFieldChannelArticle(String queryfield,String startdate, String enddate, String channel_name,String articlename, String filter,String filtertype)
      ...
      if(filter != null && !filter.isEmpty()  && filter.equals("visitorCount") )
      query = "Select "+queryfield+",cookie_id FROM enhanceduserdatabeta1 where refcurrentoriginal like '%"+articlename+"%' and channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "' GROUP by "+ queryfield+",cookie_id";  
		    ...
		    if ((lines != null) && (!lines.isEmpty()) && (!((String)lines.get(0)).isEmpty()))
		    {
		     ...
		     //   String demographicproperties = demographicmap.get(data[0]);
	               ...
	               if(queryfield.equals("country"))
	        	  {
			        ...
			        String articleparts[] = articlename.split("/"); String articleTitle = articleparts[articleparts.length-1];articleTitle = articleTitle.replace("-"," ");articleTitle=capitalizeString(articleTitle);obj.setArticleTitle(articleTitle);obj.setArticle(articlename);
			     //   Article article = GetMiddlewareData.getArticleMetaData(data[0]);String articleImage = article.getMainimage();obj.setArticleImage(articleImage);String authorName = article.getAuthor();obj.setArticleAuthor(articleAuthor);if(article.getArticletitle() != null && !article.getArticletitle().isEmpty()){ articleTitle = article.getArticletitle();obj.setArticleTitle(articleTitle);}
			        pubreport.add(obj);
  ...
  public List<PublisherReport> getQueryFieldChannelArticleFilter(String queryfield,String startdate, String enddate, String channel_name,String articlename, Map<String,String>filter, String filterMetric)
		    throws SQLFeatureNotSupportedException, SqlParseException, CsvExtractorException, Exception
		  {
	        ...
	        if(filterMetric != null && !filterMetric.isEmpty() && filterMetric.equals("visitorCount"))
		     query = "Select "+queryfield+",cookie_id from enhanceduserdatabeta1 where "+queryfilterbuilder+" and refcurrentoriginal like '%"+articlename+"%' and channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "'" + " GROUP BY "+queryfield+",cookie_id";
  ...
  /* 
		  public List<PublisherReport> getQueryFieldChannelArticleFilter(String queryfield,String startdate, String enddate, String channel_name,String articlename, Map<String,String>filter)
				    throws SQLFeatureNotSupportedException, SqlParseException, CsvExtractorException, Exception
				  {
			        ...
			        if(filter != null && !filter.isEmpty() && filter.equals("visitorCount"))
				     query = "Select "+queryfield+",cookie_id from enhanceduserdatabeta1 where "+queryfilterbuilder+" and refcurrentoriginal like '%"+articlename+"%' and channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "'" + " GROUP BY "+queryfield;
		  ...
		  */
		  ...
		  public List<PublisherReport> getQueryFieldChannelArticleGroupBy(String queryfield,String startdate, String enddate, String channel_name, String articlename, List<String> groupby, String filter)
		      ...
		      if(filter == null || filter.isEmpty() ||  filter.equals("pageviews"))
		    	    ...
		    	    if(filter != null && !filter.isEmpty()  && filter.equals("visitorCount"))
		    	     	query = "Select "+queryfield+","+querygroupbybuilder+",cookie_id  from enhanceduserdatabeta1 where refcurrentoriginal like '%"+articlename+"%' and  channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "'" + " GROUP BY "+queryfield+","+querygroupbybuilder+",cookie_id";
		    	    ...
		    	    if(querygroupbybuilder.equals("hour")){
		    	    	if(filter != null && !filter.isEmpty() &&  filter.equals("visitorCount"))
		    	    	query = "Select "+queryfield+",cookie_id from enhanceduserdatabeta1 where refcurrentoriginal like '%"+articlename+"%' and  channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "'" + " GROUP BY "+queryfield+","+"date_histogram(field='request_time','interval'='1h'),cookie_id";
		    	    ...
		    	    if(querygroupbybuilder.equals("minute")){
		    	   	if(filter != null && !filter.isEmpty() &&  filter.equals("visitorCount"))
		    	    	query = "Select "+queryfield+",cookie_id from enhanceduserdatabeta1 where refcurrentoriginal like '%"+articlename+"%' and  channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "'" + " GROUP BY "+queryfield+","+"date_histogram(field='request_time','interval'='1m'),cookie_id";
		    	    ...
		    	    //	if(filter != null && !filter.isEmpty() &&  filter.equals("visitorCount"))
		    	    	//query = "Select "
		    	    	//		+ queryfield+",cookie_id from enhanceduserdatabeta1 where refcurrentoriginal like '%"+articlename+"%' and  channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "'" + " GROUP BY "+queryfield+","+"date_histogram(field='request_time','interval'='1s'),cookie_id";
		  ...
		  public List<PublisherReport> getQueryFieldChannelSection(String queryfield,String startdate, String enddate, String channel_name,String sectionid, String filter)
		        ...
		        if(filter != null && !filter.isEmpty()  && filter.equals("visitorCount") )
		        query = "Select "+queryfield+",cookie_id FROM enhanceduserdatabeta1 where refcurrentoriginal like '%"+sectionid+"%' and channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "' GROUP by "+ queryfield+",cookie_id";  
		  ...
		  public List<PublisherReport> getQueryFieldChannelSectionFilter(String queryfield,String startdate, String enddate, String channel_name, String sectionname, Map<String,String>filter, String filtermetric)
				    throws SQLFeatureNotSupportedException, SqlParseException, CsvExtractorException, Exception
				  {
			        ...
			        if(filtermetric != null && !filtermetric.isEmpty() && filtermetric.equals("visitorCount"))
				    query = "Select "+queryfield+",cookie_id from enhanceduserdatabeta1 where "+queryfilterbuilder+" and refcurrentoriginal like '%"+sectionname+"%' and channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "'" + " GROUP BY "+queryfield+",cookie_id";
				...
				/*  
				  public List<PublisherReport> getQueryFieldChannelSectionFilter(String queryfield,String startdate, String enddate, String channel_name, String sectionname, Map<String,String>filter)
						    throws SQLFeatureNotSupportedException, SqlParseException, CsvExtractorException, Exception
						  {
					        ...
					        if(filter != null && !filter.isEmpty() && filter.equals("visitorCount"))
						    query = "Select "+queryfield+",cookie_id from enhanceduserdatabeta1 where "+queryfilterbuilder+" and refcurrentoriginal like '%"+sectionname+"%' and channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "'" + " GROUP BY "+queryfield;
				  ...
				  */
				  ...
				  public List<PublisherReport> getQueryFieldChannelSectionGroupBy(String queryfield,String startdate, String enddate, String channel_name, String sectionname,List<String> groupby, String  filter)
				      ...
				      if(filter == null || filter.isEmpty() ||  filter.equals("pageviews"))
				    	    ...
				    	    if(filter != null && !filter.isEmpty()  && filter.equals("visitorCount"))
				    	     	query = "Select "+queryfield+","+querygroupbybuilder+",cookie_id from enhanceduserdatabeta1 where refcurrentoriginal like '%"+sectionname+"%' and  channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "'" + " GROUP BY "+queryfield+","+querygroupbybuilder+",cookie_id";
				    	   ...
				    	   // 	if(filter == null || filter.isEmpty() ||  filter.equals("pageviews"))
				    	    ...
				    	    if(querygroupbybuilder.equals("hour")){
				    	    	if(filter != null && !filter.isEmpty() &&  filter.equals("visitorCount"))
				    	    	query = "Select "+queryfield+",cookie_id from enhanceduserdatabeta1 where refcurrentoriginal like '%"+sectionname+"%' and  channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "'" + " GROUP BY "+queryfield+","+"date_histogram(field='request_time','interval'='1h'),cookie_id";
				    	    ...
				    	    if(querygroupbybuilder.equals("minute")){
				    	    	if(filter != null && !filter.isEmpty() &&  filter.equals("visitorCount"))
				    	    	query = "Select "+queryfield+",cookie_id from enhanceduserdatabeta1 where refcurrentoriginal like '%"+sectionname+"%' and  channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "'" + " GROUP BY "+queryfield+","+"date_histogram(field='request_time','interval'='1m'),cookie_id";
				    	 ...
				    	 //   	if(filter != null && !filter.isEmpty() &&  filter.equals("visitorCount"))
				    	    //	query = "Select "
				    	    	//		+ ","+queryfield+",cookie_id from enhanceduserdatabeta1 where refcurrentoriginal like '%"+sectionname+"%' and  channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "'" + " GROUP BY "+queryfield+","+"date_histogram(field='request_time','interval'='1s'),cookie_id";
